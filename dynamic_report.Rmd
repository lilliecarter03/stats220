...
```{r, fig.align='center'}
knitr::include_graphics(path = "spoticat_gif")

frame1 <- image_read(path = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyilbHnit0w6Eh1NxdeCGVOsPz1fJeTxK4eQ&s") %>%
  image_scale(200) %>%
  image_extent("200x200")

frame2 <- image_read(path = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyilbHnit0w6Eh1NxdeCGVOsPz1fJeTxK4eQ&s") %>%
  image_scale(150) %>%
  image_extent("200x200")

frame3 <- image_read(path = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyilbHnit0w6Eh1NxdeCGVOsPz1fJeTxK4eQ&s") %>%
  image_scale(100) %>%
  image_extent("200x200")

frame4 <- image_read(path = "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQyilbHnit0w6Eh1NxdeCGVOsPz1fJeTxK4eQ&s") %>%
  image_scale(50) %>%
  image_extent("200x200")
