...
```{r}
frame1 <- image_read(path = "spoticat.png") %>%
  image_scale(200) %>%
  image_extent("200x200")

frame2 <- image_read(path = "spoticat.png") %>%
  image_scale(150) %>%
  image_extent("200x200")

frame3 <- image_read(path = "spoticat.png") %>%
  image_scale(100) %>%
  image_extent("200x200")

frame4 <- image_read(path = "spoticat.png") %>%
  image_scale(50) %>%
  image_extent("200x200")
...
image_write(spoticat_gif, "spoticat.gif")
```
