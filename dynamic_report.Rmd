...
## Exploring music data through what songs I added to my playlists over a 4 day period.
### Lillie Carter - lcar972

The data explored throughout this HTML files was collected through a Google Form. Whenever I added a new song to one of my playlists on Spotify, I completed this Google Form by filling out a range of information relevant to the particular song I added to my playlist.
...
# uploading my data
logged_data <- read_csv("project2_data.csv")
...
## Exploring some summary values of my data set

### Analysis of the song_length_s variable
```{r}
# exploring the summary values of my data set 
# song_length_s variable
...
```{r}
# exploring the summary values of my data set 
# song_title & song_artist variables
